  ...
  <v-container fluid class="container ">
    ...
    <v-card max-width="600" elevation="10" class="rounded-lg mx-auto mt-auto" tile>
      ...
      <div class="d-flex flex-column align-center mt-4">
        <v-text-field v-model="userName" color="#48126A" label="Enter User Name" required class="textfield mt-6"
          prepend-inner-icon="mdi-email" outlined>
        </v-text-field>
        <v-text-field label="Enter Password" color="#48126A" v-model="password" type="password" required
          class="textfield" prepend-inner-icon="mdi-lock" outlined>
        </v-text-field>
      </div>
      ...
      <div class="d-flex flex-column align-center my-4">
        ...
        <v-btn color="depressed" class="my-4" id="button-signup" @click.native="$router.push('/sign-up')">
          Sign Up
