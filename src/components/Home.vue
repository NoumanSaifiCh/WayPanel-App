<template>
  ...
  <v-container fluid>
    <section>
      ...
      <!-- ---------------------SideBar------------------- -->
      <nav>
        <v-navigation-drawer v-model="drawer" dark app class="nav-color" width="180px">
          ...
          <v-list flat class="mt-5">
            <v-list-item-group v-model="selectedItem" color="black">
              <v-list-item v-for="(item, i) in items" :key="i" active-class="border" class="ml-2 my-3" :ripple="false">
                <b></b>
                <b></b>
                <v-list-item-icon class="icon-m">
                  <v-icon v-text="item.icon"></v-icon>
                  <p>
                    <v-icon class="text-caption mt-3 ms-2" v-text="item.text"></v-icon>
                  </p>
                </v-list-item-icon>
              </v-list-item>
            </v-list-item-group>
          ...
          <v-col class="col-12">
            <div class="d-flex align-center justify-space-between">
              <v-avatar class="hidden-lg-and-up" @click.stop="drawer = !drawer">
                <img src="../assets/logo.png" alt="logo" width="20px">
              ...
              <div class="hidden-md-and-down">
                <div class="d-flex"><v-text-field label="Solo" single-line solo flat class="rounded-r-0"
                    background-color="grey lighten-2" dense></v-text-field><v-btn color="#9C27B0" dark elevation="0"
                    height="38" class="rounded-l-0">
              ...
              <div class="d-flex align-center mb-3">
                  ...
                  <v-card>
                    <v-list-item-content class="justify-center">
                      <div class="mx-auto text-center">
                        ...
                        <v-btn depressed rounded text @click="updateUser()">
                          Edit Details
                        </v-btn>
                        <v-divider class="my-3"></v-divider>
                ...
                <div class="notificationIcons"><v-badge bordered color="error" content="2" overlap class="mx-2">
                    <v-icon color="secondary">
                      mdi-email
                    </v-icon>
                  </v-badge><v-badge bordered color="error" content="2" overlap class="mx-2">
                    <v-icon color="secondary">
                      mdi-bell
                    </v-icon>
                  </v-badge>
                  <v-badge bordered color="error" overlap content="2" class="mx-2">
